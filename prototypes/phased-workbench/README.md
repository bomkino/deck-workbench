...
```bash
node prototypes/phased-workbench/serve.mjs
```
...
- Curate separates project-level Picks/ratings from per-Slide shortlist, selected, alternate and rejected states;
