...
const elements = {
  ...
  openWritingImport: document.querySelector('#open-writing-import'),
  conversionPromptDialog: document.querySelector('#conversion-prompt-dialog'),
  conversionPromptHeading: document.querySelector('#conversion-prompt-heading'),
  ...
  importWriting: document.querySelector('#import-writing'),
  cancelWritingImport: document.querySelector('#cancel-writing-import'),
