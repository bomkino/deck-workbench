...
Pre-alpha. `DW-T00` proves the first integrated Apple-Silicon Story Document tracer. The first bounded `DW-W01` macOS slice adds durable Section/Slide creation and ordering; this is not the complete cross-platform Story Document ticket, a production editor or a release build.
